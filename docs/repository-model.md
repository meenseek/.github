...
- Codex 자동화 제목에는 대상과 행동을 표시합니다. 저장소별 GitHub Actions는
...
저장소를 추가하기 전에 기존 저장소의 책임 안에서 처리하거나 내부 모듈로 나눌 수
있는지 확인합니다. 분리는 독립 소유·운영의 필요성과 추가 유지 비용을 비교해
결정하며, 아래의 해당 생성·승격 조건을 함께 적용합니다.
